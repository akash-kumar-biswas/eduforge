...
@section('content')
    <style>
        /* Clean, Professional Design matching Dashboard, Instructors, and Students */
        .page-header {
            background: #fff;
            padding: 1.5rem 2rem;
            border-radius: 8px;
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="page-subtitle">Manage and monitor all courses</p>
            </div>
            <div>
    ...
    <div class="table-card">
        <div class="table-card-header">
            <h5 class="table-card-title">All Courses</h5>
        </div>
        <div class="p-3">
                ...
                <tbody>
                    @foreach($courses as $course)
                        <tr>
                            ...
                            <td>
                                <strong>{{ $course->instructor ? $course->instructor->name : 'N/A' }}</strong>
                            </td>
                            <td>
                                @if($course->type == 'free')
                                    <span class="badge-type-free">Free</span>
                                @else
                                    <span class="badge-type-paid">Paid</span>
                                @endif
                            </td>
                            <td>
                                @if($course->type == 'paid')
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.courses.edit', $course->id) }}" class="btn-action-edit"
                                        title="Edit">

            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="postcode" class="form-control" value="{{ old('postcode', $student->postcode) }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group mb-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        @if($student->image)
                            <div class="mb-2">
                                <img src="{{ asset('uploads/students/' . $student->image) }}" width="100" class="rounded-circle" alt="Student Image">
                            </div>
                        @endif

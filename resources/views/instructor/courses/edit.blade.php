                        ...
                        <form action="{{ route('instructor.courses.update', $course->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="title" class="form-label fw-bold">Course Title <span
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="type" class="form-label fw-bold">Course Type <span
                                            class="text-danger">*</span></label>
                                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type"
                                        onchange="togglePriceField()" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="price" class="form-label fw-bold">Price ($) <span class="text-danger"
                                            id="priceRequired">*</span></label>
                                    <input type="number" class="form-control @error('price') is-invalid @enderror"
                                        id="price" name="price" value="{{ old('price', $course->price) }}" step="0.01"
                                        min="0" placeholder="0.00">
                                    <small class="text-muted" id="priceHelp">Price will be set to ৳0 for free
                                        courses</small>
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="difficulty" class="form-label fw-bold">Difficulty Level <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="url" class="form-control @error('content_url') is-invalid @enderror"
                                        id="content_url" name="content_url"
                                        value="{{ old('content_url', $course->content_url) }}"
                                        placeholder="https://example.com/course-content">
                                    <small class="text-muted">Link to course materials, videos, or external
                                        resources</small>
                                    @error('content_url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <!-- Video Upload -->
                                <div class="col-md-12 mb-3">
                                    <label for="video" class="form-label fw-bold">Course Video</label>

                                    @if($course->video_path)
                                        <div class="mb-2">
                                            <p class="text-muted small mb-1">Current Video:</p>
                                            <span class="badge bg-success">{{ $course->video_path }}</span>
                                        </div>
                                    @endif
                                    ...
                                    <small class="text-muted">Accepted: MP4, AVI, MOV, WMV, FLV, MKV (Max: 500MB). Leave
                                        empty to keep current video.</small>
                                    @error('video')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <small class="text-muted">Accepted: JPG, PNG, JPEG, GIF (Max: 2MB). Leave empty to keep
                                        current image.</small>
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="mt-3" id="imagePreview" style="display: none;">
                                        ...
                                        <img src="" alt="Preview" id="preview" class="img-thumbnail"

        ...
        <div class="col-md-10 mx-auto">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h3><i class="bi bi-pencil-square"></i> Edit Course</h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror"
                                        id="type" name="type" onchange="togglePriceField()" required>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <small class="text-muted">Link to course materials or external resources</small>
                                @error('content_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="file" class="form-control @error('video') is-invalid @enderror"
                                       id="video" name="video" accept="video/*" onchange="showVideoName(event)">
                                <small class="text-muted">Accepted: MP4, AVI, MOV, WMV, FLV, MKV (Max: 500MB)</small>
                                @error('video')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if($course->image)
                                    <div class="mb-2">
                                        ...
                                        <img src="{{ asset('uploads/courses/' . $course->image) }}" alt="Current course image"
...
<script>
    ...
    function showVideoName(event) {
        const file = event.target.files[0];
        if (file) alert('Selected video: ' + file.name);
    }
